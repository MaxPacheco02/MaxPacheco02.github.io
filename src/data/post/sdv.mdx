...
export const finsa_imgs0 = [
  { src: "~/assets/images/finsa4.jpg", alt: "finsa img" },
];
...
export const sdv_demos2 = [
  { src: "~/assets/images/sdv_control.png", alt: "sdv" },
];

export const sdv_vids = [
  { id: "F9pTx4xK49E" },
  { id: "zyNIx1Jv9sY" }
];
